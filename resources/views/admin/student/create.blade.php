                        ...
                        <div class="card">
                            ...
                            <div class="card-body">     
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12 m-auto">
                                        ...
                                        <div class="form-group" {{ $errors->has('phone') ? 'has-error' : ''}}>
                                            <label> Phone </label>
                                            <input type="phone" name="phone" placeholder="Phone no" class="form-control" value="{{ old('phone') }}" maxlength="10">
                                ...
                                <div class="form-group">
                                    ...
                                    <a href="{{ route('student.index') }}" class="btn btn-success">Cancal</a>
                                </div>
